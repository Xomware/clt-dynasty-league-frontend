...
export class LeagueService {
  ...
  /**
   * Anchor league id. Any league in this dynasty chain works -- the season
   * resolver walks forward from it, so this never needs a seasonal edit.
   */
  ...
  loadWhitelistedLeague(): Observable<LeagueModel> {
    return this.resolveCurrentLeagueId(this.whitelistedLeagueId).pipe(
      switchMap((id) => this.searchLeague(id)),
    )
  }
